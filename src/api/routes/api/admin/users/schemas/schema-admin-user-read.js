import { fullSerializedUserProps } from '#api/routes/api/user/schemas/user-base.js'
import { authTokenProps, geoipRegionProps } from '#api/routes/api/user/auth-tokens/schemas/auth-token-base.js'
