 ...
 * @property {RuntimeConfig['FASTIFY_LOG_LEVEL']} level
 ...
 * @param {string | undefined} [options.role] - Runtime role for shared-process logs
 * @param {RuntimeConfig['FASTIFY_LOG_LEVEL'] | undefined} [options.level] - Minimum Pino log level
 * @returns {LoggerOptions}
 */
export function createLoggerOptions ({ serviceName, role, level = 'info' }) {
