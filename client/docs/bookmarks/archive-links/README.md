...
To add more templates, see the source list in [`bookmark-edit.js`](https://github.com/hifiwi-fi/breadcrum.net/blob/master/client/components/bookmark/bookmark-edit.js).
