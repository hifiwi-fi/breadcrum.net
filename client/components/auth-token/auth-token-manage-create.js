 ...
 * @import { TypeAuthTokenCreateResponseClient } from '#api/routes/api/user/auth-tokens/schemas/schema-auth-token-create-response.js'
 * @import { TypeAuthTokenUpdate } from '#api/routes/api/user/auth-tokens/schemas/schema-auth-token-update.js'
 */
