# Breadcrum.net Security Overview

_Last updated: [Date]_

We take security seriously at Breadcrum.net.
...
Breadcrum is hosted on [Fly.io](https://fly.io), a secure cloud platform with per-instance firewalls and isolated app environments.
...
- Content and media are stored on [Backblaze B2](https://www.backblaze.com/b2/), a durable and encrypted storage provider.
- Email delivery is handled through [AWS Simple Email Service (SES)](https://aws.amazon.com/ses/).
