# Breadcrum.net Terms of Service

_Last updated: [Date]_

Welcome to Breadcrum.net ("Breadcrum", "we", "our", or "us").
...
Breadcrum is a bookmarking and archiving service that lets users save articles, podcasts, and media from around the web for personal, private use.
This agreement governs your access to and use of the Breadcrum website and services.
...
Breadcrum currently offers free access.
...
To request a refund, contact us at [support@breadcrum.net](mailto:support@breadcrum.net).
...
Breadcrum uses third-party services for infrastructure and functionality:
- Hosting: Fly.io
