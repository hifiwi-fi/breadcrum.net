 ...
 */
export default async function unsubscribeRoutes (fastify) {
  fastify.get('/', {
    schema: {
      tags: ['html'],
      response: {
  ...
  }, async function getUnsubscribeHandler (request, reply) {
  ...
  }, async function postUnsubscribeHandler (request, reply) {
