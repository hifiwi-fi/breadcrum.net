 ...
 */
export default async function emailConfirmRoutes (fastify) {
  fastify.get('/', {
    schema: {
      tags: ['html'],
      response: {
  ...
  }, async function getEmailConfirmHandler (request, reply) {
  ...
  }, async function postEmailConfirmHandler (request, reply) {
